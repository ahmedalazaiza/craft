    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[99999] flex items-end sm:items-center justify-center p-0 sm:p-4">
        ...
        <motion.div
          ...
          className="relative w-full max-w-lg overflow-hidden rounded-t-[32px] sm:rounded-[28px] border-t sm:border border-red-500/30 bg-[var(--bg-elevated)] p-6 sm:p-8 shadow-[0_24px_60px_-12px_rgba(0,0,0,0.25)] dark:shadow-none z-10 pb-[calc(env(safe-area-inset-bottom,0px)+20px)] sm:pb-8"
        >
