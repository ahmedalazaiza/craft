    ...
    <div className={cn("flex flex-col items-center justify-center gap-3.5", className)}>
      <div className={cn("relative flex items-center justify-center", current.box)}>
        ...
        <motion.div
          ...
          className="absolute inset-0 rounded-2xl bg-[#8DFF00]/25 blur-md"
        />
        ...
        <motion.div
          ...
          className="absolute inset-0 border border-[#8DFF00]/40 bg-[var(--bg-neutral)]/80 backdrop-blur-xs shadow-xs"
        />
        ...
        <motion.div
          ...
          className="absolute w-1/2 h-1/2 rounded-md border border-[#8DFF00]/80 bg-[#8DFF00]/10"
        />
        ...
        <motion.div
          ...
          className={cn("rounded-full bg-[#8DFF00] shadow-[0_0_10px_#8DFF00]", current.dot)}
        />
      </div>
