    ...
    <AnimatePresence>
      {!isOnline ? (
        ...
        <motion.div
          ...
          exit={{ y: 50, opacity: 0, scale: 0.95 }}
          transition={{ duration: 0.25, ease: "easeOut" }}
          className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2.5 rounded-full bg-[var(--chip-bg)]/95 border border-[var(--accent)]/40 px-4 py-2.5 text-xs text-[var(--chip-fg)] shadow-2xl dark:shadow-none backdrop-blur-md"
        >
          <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[var(--accent)]/20 text-[var(--accent)]">
