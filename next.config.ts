...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://media.layerat.com https://*.r2.cloudflarestorage.com https://*.supabase.co https://ttjobsgglwgyioqlldqj.supabase.co wss://*.supabase.co https://accounts.google.com/gsi/",
    ...
    return [
      {
        ...
        destination: "https://www.layerat.com/:path*",
        permanent: true,
      },
    ];
  },
