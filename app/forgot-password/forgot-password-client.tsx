...
export function ForgotPasswordClient() {
          ...
          <Card elevated className="border border-[var(--border-neutral)] bg-[var(--bg-screen)] rounded-[28px] p-4 sm:p-6 text-center shadow-xl">
            ...
            <CardContent className="space-y-5 pt-2">
              ...
              <div className="pt-2 border-t border-[var(--border-neutral)] flex items-center justify-between text-xs">
                ...
                <Link
                  href="/signup"
                  className="font-semibold text-[var(--content-primary)] hover:underline"
                >
  ...
  return (
    <div className="flex min-h-[calc(100vh-14rem)] flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-[140px]">
      <FadeIn className="w-full max-w-md">
        <Card elevated className="border border-[var(--border-neutral)] bg-[var(--bg-screen)] rounded-[28px] p-4 sm:p-6 shadow-xl">
          <CardHeader className="text-center pb-4 pt-4">
            <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-[var(--bg-neutral)] border border-[var(--border-neutral)] text-[var(--content-primary)] shadow-sm">
            ...
            <p className="mt-2 text-xs sm:text-sm text-[var(--content-secondary)] max-w-sm mx-auto leading-relaxed">
