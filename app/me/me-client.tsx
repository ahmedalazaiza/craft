          ...
          <aside className="lg:col-span-4 lg:sticky lg:top-24 space-y-6">
            <div className="rounded-[28px] bg-[var(--bg-elevated)] border border-[var(--border-neutral)] p-6 sm:p-7 shadow-[0_12px_32px_rgba(9,12,9,0.04)] space-y-6">
              ...
              <div className="flex flex-col items-center text-center">
                <div className="relative h-28 w-28 rounded-full overflow-hidden bg-[var(--bg-neutral)] ring-4 ring-[var(--border-neutral)] shadow-sm mb-4">
                  <Image
                    src={user.avatarUrl}
                ...
                <div className="flex items-center gap-1.5 justify-center">
                  ...
                  <CheckCircle2 className="h-5 w-5 text-[#8DFF00] fill-[#8DFF00] text-[#090C09]" />
                </div>
              ...
              <div className="pt-2 border-t border-[var(--border-neutral)]">
                ...
                >
                  <Share2 className="h-3.5 w-3.5 text-[#8DFF00]" />
